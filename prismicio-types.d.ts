...
interface RepeatableZoneDocumentData {}

/**
 * Repeatable Zone document from Prismic
 *
 * - **API ID**: `repeatable_zone`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/custom-types
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type RepeatableZoneDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<
    Simplify<RepeatableZoneDocumentData>,
    "repeatable_zone",
    Lang
  >;
...
export interface ExperienceSliceDefaultPrimaryExperienceItem {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.experience[].instituition
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface TechListSliceDefaultPrimaryTechsItem {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.techs[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
   ...
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.techs[].tech_color
...
export interface TechListSliceDefaultPrimary {
   ...
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.techs[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
